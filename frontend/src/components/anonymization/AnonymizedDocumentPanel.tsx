...
export default function AnonymizedDocumentPanel({ mode, onModeChange, anonymizedText, anonymizedContent, contentRevision, reviewMarkers, pendingMarkers, redactionMarkers, onChange, onRedactionClick, onPendingClick, onReviewClick }: Props) {
