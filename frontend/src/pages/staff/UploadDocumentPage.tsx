...
export default function UploadDocumentPage() {
  ...
  return <AppLayout><div className='document-upload-page'><h1>Загрузка и обезличивание судебного документа</h1>{error && <p className='error-message'>{error}</p>}
    ...
    {tab==='preview' && <div className='preview-tab'><CourtDocumentView document={{id:'draft',title:title || 'Черновик',act_type:actType,text:sourceText,content:source,content_format:'TIPTAP_JSON'}} content={source} contentFormat='TIPTAP_JSON' text={sourceText} /></div>}
    </div>
